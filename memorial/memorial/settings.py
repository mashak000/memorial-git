...
from alldays.services import initialize_gspread
...
SECRET_KEY = 'django-insecure-wg4*d+6vz0rhf7^0xa1x*v3=wo--qjezy%$55xl_5e#k7d3=2('
...
DJANGO_SETTINGS_MODULE = 'memorial.settings'
